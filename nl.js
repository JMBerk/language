moot.language = {
   ...
   givebody: 'Veld mag niet leeg zijn.',
   show_old: 'Toon oudste reacties',
   show_more: 'Toon meer replies',
   show_new: 'Toon nieuwste reacties',
   start: 'Start een nieuw topic...',
   domain: 'Forum URL',
   ...
   admin: 'Admin',
   someone: 'Iemand',
   writing: 'is bezig met schrijven...',
   basic: 'Basic (gratis)',
   subs: 'Subscriptions',
   manage: 'Manage',
   fullview: 'Volledige view',
   title: 'Titel',
   link: 'link',
   ...
   css: 'CSS file',
   mootbrand: 'Gebruik Moot branding',
   sso: 'Single Sign-On',
   apikey: 'API key',
